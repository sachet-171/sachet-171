...
I design, build, and ship production mobile apps that reach tens of thousands of users. With **4+ years** in Flutter, I own features end to end — clean architecture, predictable state management, real-time chat, AI-integrated flows, maps, crash-free releases, and shipping on both the Play Store and App Store.
...
[![GitHub](https://img.shields.io/badge/GitHub-sachet--171-181717?style=flat&logo=github&logoColor=white)](https://github.com/sachet-171)
...
I lead features from architecture through delivery — state management, API integration, WebSocket chat, AI-assisted flows, maps, navigation, crash monitoring, and store releases on Android and iOS. I have also **mentored and trained developers**, run code reviews, and set engineering standards across teams.

I have a strong **hunger to learn** and continuously sharpen my craft in scalable architecture, AI integration, observability, testing, CI/CD, and performance — always pushing toward cleaner, faster, more reliable apps.
...
| **Quality & Monitoring** | Firebase Crashlytics & Sentry crash reporting, Alice network inspection, structured logging, crash-free release tracking |
...
![Alice](https://img.shields.io/badge/Alice_Inspector-FF4088?style=flat&logo=flutter&logoColor=white)
...
| **[Cordia](https://play.google.com/store/apps/details?id=ai.goldencircle.app&pcampaignid=web_share)** | AI-powered note-taking & productivity app — AI-based conversational assistant, meeting notes and management, all in one workspace. Built with Flutter, Bloc, and clean architecture. [iOS](https://apps.apple.com/us/app/cordia-personal-crm/id6778693583) |
...
- **Crash-free, observable releases** — Firebase Crashlytics & Sentry monitoring, Alice for network debugging
...
| | |
|---|---|
| Mentored & trained Flutter developers | Feature ownership from design to release |
| Code reviews & engineering standards | Release & deployment ownership |
| Cross-functional work with design & backend | Strong Git flow and team collaboration |
...
| Performance profiling | Observability & crash analytics |
